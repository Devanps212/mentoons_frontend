...
const PersonalReport = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative py-10 w-full h-auto flex justify-between items-center gap-20 px-4 md:px-20 overflow-hidden"
    >
      <img
      ...
      >
        ...
        <motion.ul
          ...
          className="text-white space-y-8 mulish text-md sm:text-lg mt-6"
        >
