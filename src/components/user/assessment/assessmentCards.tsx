...
const AssessmentCards = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="p-5 md:p-15 mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 place-items-start"
      initial="hidden"
    ...
    >
      {ASSESSMENTS.map((data, index) => (
        ...
        >
          ...
          <motion.p
            className="inter text-sm md:text-md tracking-[0.35px] w-full"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
