  ...
  const assessmentBenefit = [
    {
      icon: (
        <img
          src="/icons/user/assessment/discoverYourself/Quiz.png"
          alt="quiz"
    ...
    },
    {
      icon: (
        <img
          src="/icons/user/assessment/discoverYourself/Check Document.png"
          alt="check-document"
          className="w-auto max-w-[50px] md:max-w-[70px]"
        />
      ),
    ...
    },
    {
      icon: (
        <img
          src="/icons/user/assessment/discoverYourself/Positive Dynamic.png"
          alt=""
          className="w-auto max-w-[50px] md:max-w-[70px]"
        />
      ),
