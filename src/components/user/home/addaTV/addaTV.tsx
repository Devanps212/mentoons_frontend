...
const AddaTV = () => {
  return (
    <div className="relative w-full md:w-[410px] lg:w-[500px] xl:w-[590px] h-auto flex justify-center items-center">
      ...
      <div
        className="absolute mentoons-video top-1/2 left-1/2 w-[65%] lg:w-[84%] h-[70%] bg-black -translate-x-1/2 lg:-translate-x-[50%] -translate-y-1/2 rounded-t-[60px] overflow-hidden flex items-center justify-center"
